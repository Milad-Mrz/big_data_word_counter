...
public class P1A2_HadoopWordPairs extends Configured implements Tool {
...
public static class Reduce extends Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(P1A2_HadoopWordPairs.class);
    ...
    public static void main(String[] args) throws Exception {
        int ret = ToolRunner.run(new Configuration(), new P1A2_HadoopWordPairs(), args);
        System.exit(ret);
    }
}
